...
Description: "Cross version extension for ClaimResponse.addItem from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     ClaimResponse
* extension contains provider- 0..* and net- 0..* and noteNumber- 0..* and detail- 0..* and detailSequence- 0..* and bodySite- 0..* and modifier- 0..* and quantity- 0..* and unitPrice- 0..* and revenue- 0..* and programCode- 0..* and traceNumber- 0..* and request- 0..* and serviced- 0..* and id- 0..* and tax- 0..* and itemSequence- 0..* and factor- 0..* and subdetailSequence- 0..* and productOrServiceEnd- 0..* and location- 0..* and productOrService- 0..*
* extension[provider-]
