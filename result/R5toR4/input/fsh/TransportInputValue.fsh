Extension:   TransportInputValue
Id:          extension-Transport.input.value
Title:       "Transport Input Value[x] "
Description: "Cross version extension for Transport.input.value[x] from FHIR version 5.0.0 to FHIR version 4.0.1"
