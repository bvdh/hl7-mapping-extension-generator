Extension:   AdverseEventContributingFactorItem
Id:          extension-AdverseEvent.contributingFactor.item
Title:       "AdverseEvent ContributingFactor Item[x] "
Description: "Cross version extension for AdverseEvent.contributingFactor.item[x] from FHIR version 5.0.0 to FHIR version 4.0.1"
