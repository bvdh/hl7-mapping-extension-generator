Extension:   OrganizationAffiliationContact
Id:          extension-OrganizationAffiliation.contact
Title:       "OrganizationAffiliation Contact "
Description: "Cross version extension for OrganizationAffiliation.contact from FHIR version 5.0.0 to FHIR version 4.0.1"
