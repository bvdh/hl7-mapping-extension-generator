Extension:   TransportOutputValue
Id:          extension-Transport.output.value
Title:       "Transport Output Value[x] "
Description: "Cross version extension for Transport.output.value[x] from FHIR version 5.0.0 to FHIR version 4.0.1"
