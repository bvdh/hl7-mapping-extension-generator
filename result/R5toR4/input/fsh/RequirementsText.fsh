Extension:   RequirementsText
Id:          extension-Requirements.text
Title:       "Requirements Text "
Description: "Cross version extension for Requirements.text from FHIR version 5.0.0 to FHIR version 4.0.1"
