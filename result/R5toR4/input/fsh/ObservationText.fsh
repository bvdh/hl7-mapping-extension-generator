Extension:   ObservationText
Id:          extension-Observation.text
Title:       "Observation Text "
Description: "Cross version extension for Observation.text from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     Observation
