...
Id:          extension-StructureDefinition.differential
Title:       "StructureDefinition Differential "
Description: "Cross version extension for StructureDefinition.differential from FHIR version 5.0.0 to FHIR version 4.0.1"
