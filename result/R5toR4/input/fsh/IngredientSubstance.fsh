Extension:   IngredientSubstance
Id:          extension-Ingredient.substance
Title:       "Ingredient Substance "
Description: "Cross version extension for Ingredient.substance from FHIR version 5.0.0 to FHIR version 4.0.1"
* extension contains id- 0..* and code- 0..* and strength- 0..*
* extension[id-]
  * value[x] only string
* extension[code-]
