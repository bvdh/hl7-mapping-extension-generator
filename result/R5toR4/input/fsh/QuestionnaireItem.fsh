...
Description: "Cross version extension for Questionnaire.item from FHIR version 5.0.0 to FHIR version 4.0.1"
...
* extension[disabledDisplay-]
  * value[x] only code
  * valueCode from CrossVersion-QuestionnaireItemDisabledDisplay (required)
