Extension:   AppointmentText
Id:          extension-Appointment.text
Title:       "Appointment Text "
Description: "Cross version extension for Appointment.text from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     Appointment
