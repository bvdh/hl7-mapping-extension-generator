Extension:   SubscriptionText
Id:          extension-Subscription.text
Title:       "Subscription Text "
Description: "Cross version extension for Subscription.text from FHIR version 5.0.0 to FHIR version 4.0.1"
