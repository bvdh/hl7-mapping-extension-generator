Extension:   StructureDefinitionSnapshotElement
Id:          extension-StructureDefinition.snapshot.element
Title:       "StructureDefinition Snapshot Element "
Description: "Cross version extension for StructureDefinition.snapshot.element from FHIR version 5.0.0 to FHIR version 4.0.1"
