...
Description: "Cross version extension for DeviceDefinition.udiDeviceIdentifier from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     DeviceDefinition, DeviceDefinition.packaging
