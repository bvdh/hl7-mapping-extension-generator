...
Description: "Cross version extension for EvidenceVariable.characteristic from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     EvidenceVariable, EvidenceVariable.characteristic.definitionByCombination
...
* extension[definitionReference-]
  * value[x] only Reference
  * valueReference only Reference( EvidenceVariable or Group or Evidence)
