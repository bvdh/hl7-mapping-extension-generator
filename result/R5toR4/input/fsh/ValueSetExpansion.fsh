...
Description: "Cross version extension for ValueSet.expansion from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     ValueSet
* extension contains parameter- 0..* and id- 0..* and property- 0..* and next- 0..* and identifier- 0..* and timestamp- 0..* and total- 0..* and contains- 0..* and offset- 0..*
* extension[parameter-]
...
* extension[id-]
  * value[x] only string
* extension[property-]
  * extension contains id- 0..* and uri- 0..* and code- 0..*
  * extension[id-]
    * value[x] only string
  * extension[uri-]
    * value[x] only uri
