...
Description: "Cross version extension for MedicationKnowledge.cost from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     MedicationKnowledge, MedicationKnowledge.packaging
