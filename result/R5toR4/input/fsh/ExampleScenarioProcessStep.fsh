...
Description: "Cross version extension for ExampleScenario.process.step from FHIR version 5.0.0 to FHIR version 4.0.1"
Context:     ExampleScenario.process, ExampleScenario.process.step.alternative
