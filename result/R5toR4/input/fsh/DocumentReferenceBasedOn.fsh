Extension:   DocumentReferenceBasedOn
Id:          extension-DocumentReference.basedOn
Title:       "DocumentReference BasedOn "
Description: "Cross version extension for DocumentReference.basedOn from FHIR version 5.0.0 to FHIR version 4.0.1"
