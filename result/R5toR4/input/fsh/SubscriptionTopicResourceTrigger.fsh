...
Description: "Cross version extension for SubscriptionTopic.resourceTrigger from FHIR version 5.0.0 to FHIR version 4.0.1"
...
* extension[supportedInteraction-]
  * value[x] only code
  * valueCode from CrossVersion-InteractionTrigger (required)
