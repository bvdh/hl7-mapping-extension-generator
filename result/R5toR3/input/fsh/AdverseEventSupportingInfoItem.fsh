Extension:   AdverseEventSupportingInfoItem
Id:          extension-AdverseEvent.supportingInfo.item
Title:       "AdverseEvent SupportingInfo Item[x] "
Description: "Cross version extension for AdverseEvent.supportingInfo.item[x] from FHIR version 5.0.0 to FHIR version 3.0.1"
