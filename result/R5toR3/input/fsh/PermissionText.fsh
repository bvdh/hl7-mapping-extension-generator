Extension:   PermissionText
Id:          extension-Permission.text
Title:       "Permission Text "
Description: "Cross version extension for Permission.text from FHIR version 5.0.0 to FHIR version 3.0.1"
