Extension:   IngredientText
Id:          extension-Ingredient.text
Title:       "Ingredient Text "
Description: "Cross version extension for Ingredient.text from FHIR version 5.0.0 to FHIR version 3.0.1"
