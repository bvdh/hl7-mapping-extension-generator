Extension:   TransportText
Id:          extension-Transport.text
Title:       "Transport Text "
Description: "Cross version extension for Transport.text from FHIR version 5.0.0 to FHIR version 3.0.1"
