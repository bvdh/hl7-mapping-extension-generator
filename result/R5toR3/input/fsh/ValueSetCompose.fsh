...
Description: "Cross version extension for ValueSet.compose from FHIR version 5.0.0 to FHIR version 3.0.1"
Context:     ValueSet
* extension contains inactive- 0..* and id- 0..* and include- 0..* and property- 0..* and lockedDate- 0..*
* extension[inactive-]
