Extension:   TaskOutputValue
Id:          extension-Task.output.value
Title:       "Task Output Value[x] "
Description: "Cross version extension for Task.output.value[x] from FHIR version 5.0.0 to FHIR version 3.0.1"
Context:     Task.output
