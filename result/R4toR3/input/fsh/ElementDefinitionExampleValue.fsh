Extension:   ElementDefinitionExampleValue
Id:          extension-ElementDefinition.example.value
Title:       "ElementDefinition Example Value[x] "
Description: "Cross version extension for ElementDefinition.example.value[x] from FHIR version 4.0.1 to FHIR version 3.0.1"
