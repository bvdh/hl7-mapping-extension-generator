...
Description: "Cross version extension for Questionnaire.item from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     Questionnaire, Questionnaire.item
* extension contains initial- 0..* and repeats- 0..* and answerValueSet- 0..* and answerOption- 0..* and definition- 0..* and code- 0..* and type- 0..* and enableBehavior- 0..* and enableWhen- 0..* and text- 0..* and maxLength- 0..* and id- 0..* and readOnly- 0..* and linkId- 0..* and prefix- 0..* and required- 0..*
* extension[initial-]
