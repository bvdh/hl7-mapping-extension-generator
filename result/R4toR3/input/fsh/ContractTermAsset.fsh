...
Description: "Cross version extension for Contract.term.asset from FHIR version 4.0.1 to FHIR version 3.0.1"
...
* extension[subtype-]
  ...
  * valueCodeableConcept from CrossVersion-ContractResourceAssetSub-TypeCodes (example)
