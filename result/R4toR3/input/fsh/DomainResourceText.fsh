Extension:   DomainResourceText
Id:          extension-DomainResource.text
Title:       "DomainResource Text "
Description: "Cross version extension for DomainResource.text from FHIR version 4.0.1 to FHIR version 3.0.1"
