Extension:   AdverseEventText
Id:          extension-AdverseEvent.text
Title:       "AdverseEvent Text "
Description: "Cross version extension for AdverseEvent.text from FHIR version 4.0.1 to FHIR version 3.0.1"
