Extension:   CompartmentDefinitionText
Id:          extension-CompartmentDefinition.text
Title:       "CompartmentDefinition Text "
Description: "Cross version extension for CompartmentDefinition.text from FHIR version 4.0.1 to FHIR version 3.0.1"
