Extension:   NamingSystemText
Id:          extension-NamingSystem.text
Title:       "NamingSystem Text "
Description: "Cross version extension for NamingSystem.text from FHIR version 4.0.1 to FHIR version 3.0.1"
