Extension:   CompositionText
Id:          extension-Composition.text
Title:       "Composition Text "
Description: "Cross version extension for Composition.text from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     Composition
