Extension:   MedicationText
Id:          extension-Medication.text
Title:       "Medication Text "
Description: "Cross version extension for Medication.text from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     Medication
