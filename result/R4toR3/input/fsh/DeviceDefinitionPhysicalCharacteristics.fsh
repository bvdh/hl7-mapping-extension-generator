Extension:   DeviceDefinitionPhysicalCharacteristics
Id:          extension-DeviceDefinition.physicalCharacteristics
Title:       "DeviceDefinition PhysicalCharacteristics "
Description: "Cross version extension for DeviceDefinition.physicalCharacteristics from FHIR version 4.0.1 to FHIR version 3.0.1"
