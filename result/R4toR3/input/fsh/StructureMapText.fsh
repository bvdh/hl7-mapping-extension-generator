Extension:   StructureMapText
Id:          extension-StructureMap.text
Title:       "StructureMap Text "
Description: "Cross version extension for StructureMap.text from FHIR version 4.0.1 to FHIR version 3.0.1"
