Extension:   CatalogEntryText
Id:          extension-CatalogEntry.text
Title:       "CatalogEntry Text "
Description: "Cross version extension for CatalogEntry.text from FHIR version 4.0.1 to FHIR version 3.0.1"
