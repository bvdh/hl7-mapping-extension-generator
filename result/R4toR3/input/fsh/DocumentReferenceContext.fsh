...
Description: "Cross version extension for DocumentReference.context from FHIR version 4.0.1 to FHIR version 3.0.1"
...
* extension[practiceSetting-]
  ...
  * valueCodeableConcept from CrossVersion-PracticeSettingCodeValueSet (example)
* extension[id-]
  * value[x] only string
* extension[event-]
  * value[x] only CodeableConcept
