...
Description: "Cross version extension for MedicinalProductPharmaceutical.routeOfAdministration.targetSpecies from FHIR version 4.0.1 to FHIR version 3.0.1"
