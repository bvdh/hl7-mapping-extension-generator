Extension:   CommunicationRequestText
Id:          extension-CommunicationRequest.text
Title:       "CommunicationRequest Text "
Description: "Cross version extension for CommunicationRequest.text from FHIR version 4.0.1 to FHIR version 3.0.1"
