...
Description: "Cross version extension for Composition.section from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     Composition, Composition.section
* extension contains emptyReason- 0..* and text- 0..* and id- 0..* and entry- 0..* and title- 0..* and author- 0..* and code- 0..* and mode- 0..* and orderedBy- 0..* and focus- 0..*
