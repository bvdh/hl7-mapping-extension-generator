Extension:   PlanDefinitionText
Id:          extension-PlanDefinition.text
Title:       "PlanDefinition Text "
Description: "Cross version extension for PlanDefinition.text from FHIR version 4.0.1 to FHIR version 3.0.1"
