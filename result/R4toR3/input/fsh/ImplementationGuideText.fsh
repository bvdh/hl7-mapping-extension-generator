Extension:   ImplementationGuideText
Id:          extension-ImplementationGuide.text
Title:       "ImplementationGuide Text "
Description: "Cross version extension for ImplementationGuide.text from FHIR version 4.0.1 to FHIR version 3.0.1"
