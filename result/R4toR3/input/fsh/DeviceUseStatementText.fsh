Extension:   DeviceUseStatementText
Id:          extension-DeviceUseStatement.text
Title:       "DeviceUseStatement Text "
Description: "Cross version extension for DeviceUseStatement.text from FHIR version 4.0.1 to FHIR version 3.0.1"
