Extension:   ImagingStudyText
Id:          extension-ImagingStudy.text
Title:       "ImagingStudy Text "
Description: "Cross version extension for ImagingStudy.text from FHIR version 4.0.1 to FHIR version 3.0.1"
