Extension:   CodeSystemText
Id:          extension-CodeSystem.text
Title:       "CodeSystem Text "
Description: "Cross version extension for CodeSystem.text from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     CodeSystem
