Extension:   ActivityDefinitionText
Id:          extension-ActivityDefinition.text
Title:       "ActivityDefinition Text "
Description: "Cross version extension for ActivityDefinition.text from FHIR version 4.0.1 to FHIR version 3.0.1"
