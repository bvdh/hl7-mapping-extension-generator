...
Description: "Cross version extension for DetectedIssue.mitigation from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     DetectedIssue
* extension contains date- 0..* and id- 0..* and author- 0..* and action- 0..*
* extension[date-]
