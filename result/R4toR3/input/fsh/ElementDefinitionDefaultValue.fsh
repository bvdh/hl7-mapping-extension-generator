Extension:   ElementDefinitionDefaultValue
Id:          extension-ElementDefinition.defaultValue
Title:       "ElementDefinition DefaultValue[x] "
Description: "Cross version extension for ElementDefinition.defaultValue[x] from FHIR version 4.0.1 to FHIR version 3.0.1"
