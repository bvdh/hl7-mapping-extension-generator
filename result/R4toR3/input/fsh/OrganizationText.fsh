Extension:   OrganizationText
Id:          extension-Organization.text
Title:       "Organization Text "
Description: "Cross version extension for Organization.text from FHIR version 4.0.1 to FHIR version 3.0.1"
