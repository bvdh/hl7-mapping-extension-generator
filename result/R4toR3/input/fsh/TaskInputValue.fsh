Extension:   TaskInputValue
Id:          extension-Task.input.value
Title:       "Task Input Value[x] "
Description: "Cross version extension for Task.input.value[x] from FHIR version 4.0.1 to FHIR version 3.0.1"
Context:     Task.input
