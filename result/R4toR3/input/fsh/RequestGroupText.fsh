Extension:   RequestGroupText
Id:          extension-RequestGroup.text
Title:       "RequestGroup Text "
Description: "Cross version extension for RequestGroup.text from FHIR version 4.0.1 to FHIR version 3.0.1"
