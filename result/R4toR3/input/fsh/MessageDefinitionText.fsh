Extension:   MessageDefinitionText
Id:          extension-MessageDefinition.text
Title:       "MessageDefinition Text "
Description: "Cross version extension for MessageDefinition.text from FHIR version 4.0.1 to FHIR version 3.0.1"
