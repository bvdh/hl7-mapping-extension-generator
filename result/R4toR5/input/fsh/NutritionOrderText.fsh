Extension:   NutritionOrderText
Id:          extension-NutritionOrder.text
Title:       "NutritionOrder Text "
Description: "Cross version extension for NutritionOrder.text from FHIR version 4.0.1 to FHIR version 5.0.0"
