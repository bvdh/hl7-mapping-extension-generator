Extension:   AuditEventText
Id:          extension-AuditEvent.text
Title:       "AuditEvent Text "
Description: "Cross version extension for AuditEvent.text from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     AuditEvent
