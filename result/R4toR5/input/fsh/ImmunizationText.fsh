Extension:   ImmunizationText
Id:          extension-Immunization.text
Title:       "Immunization Text "
Description: "Cross version extension for Immunization.text from FHIR version 4.0.1 to FHIR version 5.0.0"
