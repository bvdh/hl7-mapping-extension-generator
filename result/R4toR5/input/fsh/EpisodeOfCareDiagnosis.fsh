...
Description: "Cross version extension for EpisodeOfCare.diagnosis from FHIR version 4.0.1 to FHIR version 5.0.0"
...
* extension[role-]
  ...
  * valueCodeableConcept from CrossVersion-DiagnosisRole (preferred)
