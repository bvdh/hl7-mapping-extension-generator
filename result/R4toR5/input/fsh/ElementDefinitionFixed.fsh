Extension:   ElementDefinitionFixed
Id:          extension-ElementDefinition.fixed
Title:       "ElementDefinition Fixed[x] "
Description: "Cross version extension for ElementDefinition.fixed[x] from FHIR version 4.0.1 to FHIR version 5.0.0"
