Extension:   ElementDefinitionPattern
Id:          extension-ElementDefinition.pattern
Title:       "ElementDefinition Pattern[x] "
Description: "Cross version extension for ElementDefinition.pattern[x] from FHIR version 4.0.1 to FHIR version 5.0.0"
