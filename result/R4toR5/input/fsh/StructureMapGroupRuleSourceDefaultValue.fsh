Extension:   StructureMapGroupRuleSourceDefaultValue
Id:          extension-StructureMap.group.rule.source.defaultValue
Title:       "StructureMap Group Rule Source DefaultValue[x] "
Description: "Cross version extension for StructureMap.group.rule.source.defaultValue[x] from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     StructureMap.group.rule.source
