Extension:   ClaimProcedure
Id:          extension-Claim.procedure
Title:       "Claim Procedure "
Description: "Cross version extension for Claim.procedure from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     Claim
