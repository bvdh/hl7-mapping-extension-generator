Extension:   MedicationDispenseText
Id:          extension-MedicationDispense.text
Title:       "MedicationDispense Text "
Description: "Cross version extension for MedicationDispense.text from FHIR version 4.0.1 to FHIR version 5.0.0"
