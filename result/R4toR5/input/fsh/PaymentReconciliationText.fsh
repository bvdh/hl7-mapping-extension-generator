Extension:   PaymentReconciliationText
Id:          extension-PaymentReconciliation.text
Title:       "PaymentReconciliation Text "
Description: "Cross version extension for PaymentReconciliation.text from FHIR version 4.0.1 to FHIR version 5.0.0"
