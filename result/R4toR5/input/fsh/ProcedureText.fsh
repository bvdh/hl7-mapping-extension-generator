Extension:   ProcedureText
Id:          extension-Procedure.text
Title:       "Procedure Text "
Description: "Cross version extension for Procedure.text from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     Procedure
