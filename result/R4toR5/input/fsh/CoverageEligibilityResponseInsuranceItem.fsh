Extension:   CoverageEligibilityResponseInsuranceItem
Id:          extension-CoverageEligibilityResponse.insurance.item
Title:       "CoverageEligibilityResponse Insurance Item "
Description: "Cross version extension for CoverageEligibilityResponse.insurance.item from FHIR version 4.0.1 to FHIR version 5.0.0"
