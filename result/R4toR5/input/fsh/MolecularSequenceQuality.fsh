...
Description: "Cross version extension for MolecularSequence.quality from FHIR version 4.0.1 to FHIR version 5.0.0"
...
* extension[standardSequence-]
  ...
  * valueCodeableConcept from CrossVersion-FDA-StandardSequence (example)
* extension[fScore-]
  * value[x] only decimal
* extension[start-]
...
* extension[type-]
  * value[x] only code
  * valueCode from CrossVersion-qualityType (required)
* extension[truthTP-]
  * value[x] only decimal
* extension[queryFP-]
  * value[x] only decimal
...
* extension[method-]
  * value[x] only CodeableConcept
  * valueCodeableConcept from CrossVersion-FDA-Method (example)
* extension[recall-]
  * value[x] only decimal
* extension[end-]
  * value[x] only integer
