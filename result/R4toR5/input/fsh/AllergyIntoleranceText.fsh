Extension:   AllergyIntoleranceText
Id:          extension-AllergyIntolerance.text
Title:       "AllergyIntolerance Text "
Description: "Cross version extension for AllergyIntolerance.text from FHIR version 4.0.1 to FHIR version 5.0.0"
