Extension:   VerificationResultText
Id:          extension-VerificationResult.text
Title:       "VerificationResult Text "
Description: "Cross version extension for VerificationResult.text from FHIR version 4.0.1 to FHIR version 5.0.0"
