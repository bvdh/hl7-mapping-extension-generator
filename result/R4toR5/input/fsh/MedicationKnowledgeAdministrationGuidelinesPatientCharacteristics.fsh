...
Description: "Cross version extension for MedicationKnowledge.administrationGuidelines.patientCharacteristics from FHIR version 4.0.1 to FHIR version 5.0.0"
