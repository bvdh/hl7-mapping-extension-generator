...
Description: "Cross version extension for Contract.contentDefinition from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     Contract
...
* extension[publicationStatus-]
  * value[x] only code
  * valueCode from CrossVersion-ContractResourcePublicationStatusCodes (required)
* extension[publisher-]
