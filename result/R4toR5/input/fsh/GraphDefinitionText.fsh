Extension:   GraphDefinitionText
Id:          extension-GraphDefinition.text
Title:       "GraphDefinition Text "
Description: "Cross version extension for GraphDefinition.text from FHIR version 4.0.1 to FHIR version 5.0.0"
