...
Description: "Cross version extension for AdverseEvent.suspectEntity.causality from FHIR version 4.0.1 to FHIR version 5.0.0"
...
* extension[method-]
  ...
  * valueCodeableConcept from CrossVersion-AdverseEventCausalityMethod (example)
