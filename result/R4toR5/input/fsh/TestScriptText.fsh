Extension:   TestScriptText
Id:          extension-TestScript.text
Title:       "TestScript Text "
Description: "Cross version extension for TestScript.text from FHIR version 4.0.1 to FHIR version 5.0.0"
Context:     TestScript
