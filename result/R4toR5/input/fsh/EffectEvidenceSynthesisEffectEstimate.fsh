...
Description: "Cross version extension for EffectEvidenceSynthesis.effectEstimate from FHIR version 4.0.1 to FHIR version 5.0.0"
...
* extension[type-]
  * value[x] only CodeableConcept
  * valueCodeableConcept from CrossVersion-EffectEstimateType (extensible)
* extension[value-]
